...
class tlvBeaconMetricsResponse : public BaseClass
{
    public:
        ...
        uint8_t* measurement_report_list(size_t idx = 0);
        bool set_measurement_report_list(const void* buffer, size_t size);
        bool alloc_measurement_report_list(size_t count = 1);
    ...
    private:
        ...
        uint8_t* m_measurement_report_list = nullptr;
