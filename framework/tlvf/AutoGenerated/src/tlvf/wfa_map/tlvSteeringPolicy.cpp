...
bool tlvSteeringPolicy::init()
{
    ...
    m_local_steering_disallowed_sta_list_length = (uint8_t*)m_buff_ptr__;
    ...
    m_btm_steering_disallowed_sta_list_length = (uint8_t*)m_buff_ptr__;
    ...
    m_radio_ap_control_policy_list_length = (uint8_t*)m_buff_ptr__;
