...
void Ieee1905Transport::remove_packet_from_de_duplication_map(const Packet &packet)
{
    ...
    std::copy_n(packet.src.oct, ETH_ALEN, key.src);
    std::copy_n(packet.dst.oct, ETH_ALEN, key.dst);
...
std::ostream &Ieee1905Transport::Packet::print(std::ostream &os) const
{
    ...
    ss << "  dst        : " << std::hex << std::setfill('0') << std::setw(2) << (unsigned)dst.oct[0]
       << ":" << std::hex << std::setfill('0') << std::setw(2) << (unsigned)dst.oct[1] << ":"
       << std::hex << std::setfill('0') << std::setw(2) << (unsigned)dst.oct[2] << ":" << std::hex
       << std::setfill('0') << std::setw(2) << (unsigned)dst.oct[3] << ":" << std::hex
       << std::setfill('0') << std::setw(2) << (unsigned)dst.oct[4] << ":" << std::hex
       << std::setfill('0') << std::setw(2) << (unsigned)dst.oct[5] << std::endl;
    ss << "  src        : " << std::hex << std::setfill('0') << std::setw(2) << (unsigned)src.oct[0]
       << ":" << std::hex << std::setfill('0') << std::setw(2) << (unsigned)src.oct[1] << ":"
       << std::hex << std::setfill('0') << std::setw(2) << (unsigned)src.oct[2] << ":" << std::hex
       << std::setfill('0') << std::setw(2) << (unsigned)src.oct[3] << ":" << std::hex
       << std::setfill('0') << std::setw(2) << (unsigned)src.oct[4] << ":" << std::hex
       << std::setfill('0') << std::setw(2) << (unsigned)src.oct[5] << std::endl;
