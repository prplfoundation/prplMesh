...
public:
    ...
    bool set_wire_iface(char buffer[], size_t size);
    char *sta_iface(size_t length = 0);
    bool set_sta_iface(std::string &str);
    bool set_sta_iface(const std::string &str);
    bool set_sta_iface(char buffer[], size_t size);
    ...
    bool set_ap_iface(char buffer[], size_t size);
...
public:
    cACTION_BACKHAUL_DL_RSSI_REPORT_NOTIFICATION(uint8_t *buff, size_t buff_len, bool parse = false,
                                                 bool swap_needed = false);
    cACTION_BACKHAUL_DL_RSSI_REPORT_NOTIFICATION(std::shared_ptr<BaseClass> base,
...
public:
    cACTION_BACKHAUL_CLIENT_RX_RSSI_MEASUREMENT_REQUEST(uint8_t *buff, size_t buff_len,
                                                        bool parse       = false,
                                                        bool swap_needed = false);
    cACTION_BACKHAUL_CLIENT_RX_RSSI_MEASUREMENT_REQUEST(std::shared_ptr<BaseClass> base,
                                                        bool parse       = false,
                                                        bool swap_needed = false);
...
public:
    cACTION_BACKHAUL_CLIENT_RX_RSSI_MEASUREMENT_RESPONSE(uint8_t *buff, size_t buff_len,
                                                         bool parse       = false,
                                                         bool swap_needed = false);
