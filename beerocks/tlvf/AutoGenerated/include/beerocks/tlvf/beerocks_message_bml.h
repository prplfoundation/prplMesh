...
public:
    ...
    static eActionOp_BML get_action_op() { return (eActionOp_BML)(ACTION_BML_PING_REQUEST); }
    void class_swap();
...
public:
    ...
    static eActionOp_BML get_action_op() { return (eActionOp_BML)(ACTION_BML_PING_RESPONSE); }
    void class_swap();
    static size_t get_initial_size();
...
public:
    ...
    static eActionOp_BML get_action_op() { return (eActionOp_BML)(ACTION_BML_NW_MAP_REQUEST); }
    void class_swap();
    static size_t get_initial_size();
...
public:
    ...
    static eActionOp_BML get_action_op() { return (eActionOp_BML)(ACTION_BML_NW_MAP_RESPONSE); }
    uint32_t &node_num();
...
public:
    ...
    static eActionOp_BML get_action_op() { return (eActionOp_BML)(ACTION_BML_NW_MAP_UPDATE); }
    uint32_t &node_num();
    uint32_t &buffer_size();
    char *buffer(size_t length = 0);
    bool set_buffer(std::string &str);
...
public:
    ...
    static eActionOp_BML get_action_op() { return (eActionOp_BML)(ACTION_BML_STATS_UPDATE); }
...
public:
    ...
    static eActionOp_BML get_action_op() { return (eActionOp_BML)(ACTION_BML_EVENTS_UPDATE); }
    uint32_t &buffer_size();
    char *buffer(size_t length = 0);
    bool set_buffer(std::string &str);
    bool set_buffer(const std::string &str);
...
public:
    cACTION_BML_REGISTER_TO_NW_MAP_UPDATES_REQUEST(uint8_t *buff, size_t buff_len,
                                                   bool parse = false, bool swap_needed = false);
    cACTION_BML_REGISTER_TO_NW_MAP_UPDATES_REQUEST(std::shared_ptr<BaseClass> base,
                                                   bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_REGISTER_TO_NW_MAP_UPDATES_RESPONSE(uint8_t *buff, size_t buff_len,
                                                    bool parse = false, bool swap_needed = false);
    cACTION_BML_REGISTER_TO_NW_MAP_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base,
                                                    bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_UNREGISTER_FROM_NW_MAP_UPDATES_REQUEST(uint8_t *buff, size_t buff_len,
                                                       bool parse       = false,
                                                       bool swap_needed = false);
    cACTION_BML_UNREGISTER_FROM_NW_MAP_UPDATES_REQUEST(std::shared_ptr<BaseClass> base,
                                                       bool parse       = false,
                                                       bool swap_needed = false);
...
public:
    cACTION_BML_UNREGISTER_FROM_NW_MAP_UPDATES_RESPONSE(uint8_t *buff, size_t buff_len,
                                                        bool parse       = false,
                                                        bool swap_needed = false);
    cACTION_BML_UNREGISTER_FROM_NW_MAP_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base,
                                                        bool parse       = false,
                                                        bool swap_needed = false);
...
public:
    cACTION_BML_SET_LEGACY_CLIENT_ROAMING_RESPONSE(uint8_t *buff, size_t buff_len,
                                                   bool parse = false, bool swap_needed = false);
    cACTION_BML_SET_LEGACY_CLIENT_ROAMING_RESPONSE(std::shared_ptr<BaseClass> base,
                                                   bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_GET_LEGACY_CLIENT_ROAMING_REQUEST(uint8_t *buff, size_t buff_len,
                                                  bool parse = false, bool swap_needed = false);
    cACTION_BML_GET_LEGACY_CLIENT_ROAMING_REQUEST(std::shared_ptr<BaseClass> base,
                                                  bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_REGISTER_TO_EVENTS_UPDATES_REQUEST(uint8_t *buff, size_t buff_len,
                                                   bool parse = false, bool swap_needed = false);
    cACTION_BML_REGISTER_TO_EVENTS_UPDATES_REQUEST(std::shared_ptr<BaseClass> base,
                                                   bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_REGISTER_TO_EVENTS_UPDATES_RESPONSE(uint8_t *buff, size_t buff_len,
                                                    bool parse = false, bool swap_needed = false);
    cACTION_BML_REGISTER_TO_EVENTS_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base,
                                                    bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_UNREGISTER_FROM_EVENTS_UPDATES_REQUEST(uint8_t *buff, size_t buff_len,
                                                       bool parse       = false,
                                                       bool swap_needed = false);
    cACTION_BML_UNREGISTER_FROM_EVENTS_UPDATES_REQUEST(std::shared_ptr<BaseClass> base,
                                                       bool parse       = false,
                                                       bool swap_needed = false);
...
public:
    cACTION_BML_UNREGISTER_FROM_EVENTS_UPDATES_RESPONSE(uint8_t *buff, size_t buff_len,
                                                        bool parse       = false,
                                                        bool swap_needed = false);
    cACTION_BML_UNREGISTER_FROM_EVENTS_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base,
                                                        bool parse       = false,
                                                        bool swap_needed = false);
...
public:
    cACTION_BML_REGISTER_TO_STATS_UPDATES_REQUEST(uint8_t *buff, size_t buff_len,
                                                  bool parse = false, bool swap_needed = false);
    cACTION_BML_REGISTER_TO_STATS_UPDATES_REQUEST(std::shared_ptr<BaseClass> base,
                                                  bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_REGISTER_TO_STATS_UPDATES_RESPONSE(uint8_t *buff, size_t buff_len,
                                                   bool parse = false, bool swap_needed = false);
    cACTION_BML_REGISTER_TO_STATS_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base,
                                                   bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_UNREGISTER_FROM_STATS_UPDATES_REQUEST(uint8_t *buff, size_t buff_len,
                                                      bool parse = false, bool swap_needed = false);
    cACTION_BML_UNREGISTER_FROM_STATS_UPDATES_REQUEST(std::shared_ptr<BaseClass> base,
                                                      bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_UNREGISTER_FROM_STATS_UPDATES_RESPONSE(uint8_t *buff, size_t buff_len,
                                                       bool parse       = false,
                                                       bool swap_needed = false);
    cACTION_BML_UNREGISTER_FROM_STATS_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base,
                                                       bool parse       = false,
                                                       bool swap_needed = false);
...
public:
    cACTION_BML_SET_LEGACY_CLIENT_ROAMING_REQUEST(uint8_t *buff, size_t buff_len,
                                                  bool parse = false, bool swap_needed = false);
    cACTION_BML_SET_LEGACY_CLIENT_ROAMING_REQUEST(std::shared_ptr<BaseClass> base,
                                                  bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_GET_LEGACY_CLIENT_ROAMING_RESPONSE(uint8_t *buff, size_t buff_len,
                                                   bool parse = false, bool swap_needed = false);
    cACTION_BML_GET_LEGACY_CLIENT_ROAMING_RESPONSE(std::shared_ptr<BaseClass> base,
                                                   bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_SET_CLIENT_BAND_STEERING_REQUEST(uint8_t *buff, size_t buff_len, bool parse = false,
                                                 bool swap_needed = false);
    cACTION_BML_SET_CLIENT_BAND_STEERING_REQUEST(std::shared_ptr<BaseClass> base,
                                                 bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_SET_CLIENT_BAND_STEERING_RESPONSE(uint8_t *buff, size_t buff_len,
                                                  bool parse = false, bool swap_needed = false);
    cACTION_BML_SET_CLIENT_BAND_STEERING_RESPONSE(std::shared_ptr<BaseClass> base,
                                                  bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_GET_CLIENT_BAND_STEERING_REQUEST(uint8_t *buff, size_t buff_len, bool parse = false,
                                                 bool swap_needed = false);
    cACTION_BML_GET_CLIENT_BAND_STEERING_REQUEST(std::shared_ptr<BaseClass> base,
                                                 bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_GET_CLIENT_BAND_STEERING_RESPONSE(uint8_t *buff, size_t buff_len,
                                                  bool parse = false, bool swap_needed = false);
    cACTION_BML_GET_CLIENT_BAND_STEERING_RESPONSE(std::shared_ptr<BaseClass> base,
                                                  bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_CHANGE_MODULE_LOGGING_LEVEL_REQUEST(uint8_t *buff, size_t buff_len,
                                                    bool parse = false, bool swap_needed = false);
    cACTION_BML_CHANGE_MODULE_LOGGING_LEVEL_REQUEST(std::shared_ptr<BaseClass> base,
                                                    bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_CHANGE_MODULE_LOGGING_LEVEL_RESPONSE(uint8_t *buff, size_t buff_len,
                                                     bool parse = false, bool swap_needed = false);
    cACTION_BML_CHANGE_MODULE_LOGGING_LEVEL_RESPONSE(std::shared_ptr<BaseClass> base,
                                                     bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_WIFI_CREDENTIALS_UPDATE_RESPONSE(uint8_t *buff, size_t buff_len, bool parse = false,
                                                 bool swap_needed = false);
    cACTION_BML_WIFI_CREDENTIALS_UPDATE_RESPONSE(std::shared_ptr<BaseClass> base,
                                                 bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_SET_RESTRICTED_CHANNELS_RESPONSE(uint8_t *buff, size_t buff_len, bool parse = false,
                                                 bool swap_needed = false);
    cACTION_BML_SET_RESTRICTED_CHANNELS_RESPONSE(std::shared_ptr<BaseClass> base,
                                                 bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_GET_RESTRICTED_CHANNELS_RESPONSE(uint8_t *buff, size_t buff_len, bool parse = false,
                                                 bool swap_needed = false);
    cACTION_BML_GET_RESTRICTED_CHANNELS_RESPONSE(std::shared_ptr<BaseClass> base,
                                                 bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_SET_VAP_LIST_CREDENTIALS_REQUEST(uint8_t *buff, size_t buff_len, bool parse = false,
                                                 bool swap_needed = false);
    cACTION_BML_SET_VAP_LIST_CREDENTIALS_REQUEST(std::shared_ptr<BaseClass> base,
                                                 bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_SET_VAP_LIST_CREDENTIALS_RESPONSE(uint8_t *buff, size_t buff_len,
                                                  bool parse = false, bool swap_needed = false);
    cACTION_BML_SET_VAP_LIST_CREDENTIALS_RESPONSE(std::shared_ptr<BaseClass> base,
                                                  bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_GET_VAP_LIST_CREDENTIALS_RESPONSE(uint8_t *buff, size_t buff_len,
                                                  bool parse = false, bool swap_needed = false);
    cACTION_BML_GET_VAP_LIST_CREDENTIALS_RESPONSE(std::shared_ptr<BaseClass> base,
                                                  bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_GET_VAP_LIST_CREDENTIALS_REQUEST(uint8_t *buff, size_t buff_len, bool parse = false,
                                                 bool swap_needed = false);
    cACTION_BML_GET_VAP_LIST_CREDENTIALS_REQUEST(std::shared_ptr<BaseClass> base,
                                                 bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_STEERING_CLIENT_DISCONNECT_REQUEST(uint8_t *buff, size_t buff_len,
                                                   bool parse = false, bool swap_needed = false);
    cACTION_BML_STEERING_CLIENT_DISCONNECT_REQUEST(std::shared_ptr<BaseClass> base,
                                                   bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_STEERING_CLIENT_DISCONNECT_RESPONSE(uint8_t *buff, size_t buff_len,
                                                    bool parse = false, bool swap_needed = false);
    cACTION_BML_STEERING_CLIENT_DISCONNECT_RESPONSE(std::shared_ptr<BaseClass> base,
                                                    bool parse = false, bool swap_needed = false);
...
public:
    cACTION_BML_STEERING_CLIENT_MEASURE_RESPONSE(uint8_t *buff, size_t buff_len, bool parse = false,
                                                 bool swap_needed = false);
    cACTION_BML_STEERING_CLIENT_MEASURE_RESPONSE(std::shared_ptr<BaseClass> base,
                                                 bool parse = false, bool swap_needed = false);
