...
public:
    ...
    static eActionOp_CLI get_action_op() { return (eActionOp_CLI)(ACTION_CLI_ENABLE_DEBUG); }
    int8_t &isEnable();
    void class_swap();
    static size_t get_initial_size();
...
public:
    cACTION_CLI_SET_SLAVES_STOP_ON_FAILURE_ATTEMPTS(uint8_t *buff, size_t buff_len,
                                                    bool parse = false, bool swap_needed = false);
    cACTION_CLI_SET_SLAVES_STOP_ON_FAILURE_ATTEMPTS(std::shared_ptr<BaseClass> base,
                                                    bool parse = false, bool swap_needed = false);
...
public:
    ...
    static eActionOp_CLI get_action_op() { return (eActionOp_CLI)(ACTION_CLI_RESPONSE_INT); }
    uint8_t &isOK();
    int8_t &currentValue();
    void class_swap();
    static size_t get_initial_size();
...
public:
    ...
    static eActionOp_CLI get_action_op() { return (eActionOp_CLI)(ACTION_CLI_RESPONSE_STR); }
...
public:
    ...
    static eActionOp_CLI get_action_op() { return (eActionOp_CLI)(ACTION_CLI_OPTIMAL_PATH_TASK); }
    beerocks::net::sMacAddr &client_mac();
    void class_swap();
    static size_t get_initial_size();
...
public:
    ...
    static eActionOp_CLI get_action_op() { return (eActionOp_CLI)(ACTION_CLI_LOAD_BALANCER_TASK); }
...
public:
    ...
    static eActionOp_CLI get_action_op() { return (eActionOp_CLI)(ACTION_CLI_DUMP_NODE_INFO); }
...
public:
    ...
    static eActionOp_CLI get_action_op() { return (eActionOp_CLI)(ACTION_CLI_PING_SLAVE_REQUEST); }
    beerocks::net::sMacAddr &mac();
    uint16_t &num_of_req();
    uint16_t &size();
    void class_swap();
...
public:
    cACTION_CLI_CLIENT_LINK_MEASUREMENT_11K_REQUEST(uint8_t *buff, size_t buff_len,
                                                    bool parse = false, bool swap_needed = false);
    cACTION_CLI_CLIENT_LINK_MEASUREMENT_11K_REQUEST(std::shared_ptr<BaseClass> base,
                                                    bool parse = false, bool swap_needed = false);
...
public:
    cACTION_CLI_HOSTAP_TX_ON_REQUEST(uint8_t *buff, size_t buff_len, bool parse = false,
                                     bool swap_needed = false);
    cACTION_CLI_HOSTAP_TX_ON_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false,
                                     bool swap_needed = false);
...
public:
    cACTION_CLI_HOSTAP_TX_OFF_REQUEST(uint8_t *buff, size_t buff_len, bool parse = false,
                                      bool swap_needed = false);
    cACTION_CLI_HOSTAP_TX_OFF_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false,
                                      bool swap_needed = false);
...
public:
    cACTION_CLI_HOSTAP_REMOVE_NEIGHBOR_11K_REQUEST(uint8_t *buff, size_t buff_len,
                                                   bool parse = false, bool swap_needed = false);
    cACTION_CLI_HOSTAP_REMOVE_NEIGHBOR_11K_REQUEST(std::shared_ptr<BaseClass> base,
                                                   bool parse = false, bool swap_needed = false);
