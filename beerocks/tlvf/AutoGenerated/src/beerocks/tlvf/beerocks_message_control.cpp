...
uint8_t &cACTION_CONTROL_SLAVE_JOINED_NOTIFICATION::platform() { return (uint8_t &)(*m_platform); }
...
bool cACTION_CONTROL_SLAVE_JOINED_NOTIFICATION::init()
{
    ...
    if (!m_parse__) {
        m_radio_identifier->struct_init();
    }
...
cACTION_CONTROL_SLAVE_JOINED_RESPONSE::cACTION_CONTROL_SLAVE_JOINED_RESPONSE(uint8_t *buff,
                                                                             size_t buff_len,
                                                                             bool parse,
                                                                             bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
uint8_t &cACTION_CONTROL_SLAVE_JOINED_RESPONSE::err_code() { return (uint8_t &)(*m_err_code); }

sSonConfig &cACTION_CONTROL_SLAVE_JOINED_RESPONSE::config() { return (sSonConfig &)(*m_config); }

void cACTION_CONTROL_SLAVE_JOINED_RESPONSE::class_swap() { m_config->struct_swap(); }
...
cACTION_CONTROL_SLAVE_JOINED_4ADDR_MODE_NOTIFICATION::
    cACTION_CONTROL_SLAVE_JOINED_4ADDR_MODE_NOTIFICATION(uint8_t *buff, size_t buff_len, bool parse,
                                                         bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_SLAVE_JOINED_4ADDR_MODE_NOTIFICATION::
    cACTION_CONTROL_SLAVE_JOINED_4ADDR_MODE_NOTIFICATION(std::shared_ptr<BaseClass> base,
...
cACTION_CONTROL_SON_CONFIG_UPDATE::cACTION_CONTROL_SON_CONFIG_UPDATE(uint8_t *buff, size_t buff_len,
                                                                     bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_SON_CONFIG_UPDATE::~cACTION_CONTROL_SON_CONFIG_UPDATE() {}
sSonConfig &cACTION_CONTROL_SON_CONFIG_UPDATE::config() { return (sSonConfig &)(*m_config); }

void cACTION_CONTROL_SON_CONFIG_UPDATE::class_swap() { m_config->struct_swap(); }
...
cACTION_CONTROL_CONTROLLER_PING_REQUEST::cACTION_CONTROL_CONTROLLER_PING_REQUEST(uint8_t *buff,
                                                                                 size_t buff_len,
                                                                                 bool parse,
                                                                                 bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
cACTION_CONTROL_CONTROLLER_PING_REQUEST::~cACTION_CONTROL_CONTROLLER_PING_REQUEST() {}
uint16_t &cACTION_CONTROL_CONTROLLER_PING_REQUEST::total() { return (uint16_t &)(*m_total); }

uint16_t &cACTION_CONTROL_CONTROLLER_PING_REQUEST::seq() { return (uint16_t &)(*m_seq); }

uint16_t &cACTION_CONTROL_CONTROLLER_PING_REQUEST::size() { return (uint16_t &)(*m_size); }
...
cACTION_CONTROL_CONTROLLER_PING_RESPONSE::cACTION_CONTROL_CONTROLLER_PING_RESPONSE(uint8_t *buff,
                                                                                   size_t buff_len,
                                                                                   bool parse,
                                                                                   bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
cACTION_CONTROL_CONTROLLER_PING_RESPONSE::~cACTION_CONTROL_CONTROLLER_PING_RESPONSE() {}
uint16_t &cACTION_CONTROL_CONTROLLER_PING_RESPONSE::total() { return (uint16_t &)(*m_total); }

uint16_t &cACTION_CONTROL_CONTROLLER_PING_RESPONSE::seq() { return (uint16_t &)(*m_seq); }

uint16_t &cACTION_CONTROL_CONTROLLER_PING_RESPONSE::size() { return (uint16_t &)(*m_size); }
...
cACTION_CONTROL_AGENT_PING_REQUEST::cACTION_CONTROL_AGENT_PING_REQUEST(uint8_t *buff,
...
cACTION_CONTROL_AGENT_PING_REQUEST::~cACTION_CONTROL_AGENT_PING_REQUEST() {}
uint16_t &cACTION_CONTROL_AGENT_PING_REQUEST::total() { return (uint16_t &)(*m_total); }

uint16_t &cACTION_CONTROL_AGENT_PING_REQUEST::seq() { return (uint16_t &)(*m_seq); }

uint16_t &cACTION_CONTROL_AGENT_PING_REQUEST::size() { return (uint16_t &)(*m_size); }
...
cACTION_CONTROL_AGENT_PING_RESPONSE::cACTION_CONTROL_AGENT_PING_RESPONSE(uint8_t *buff,
                                                                         size_t buff_len,
                                                                         bool parse,
                                                                         bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
cACTION_CONTROL_AGENT_PING_RESPONSE::~cACTION_CONTROL_AGENT_PING_RESPONSE() {}
uint16_t &cACTION_CONTROL_AGENT_PING_RESPONSE::total() { return (uint16_t &)(*m_total); }

uint16_t &cACTION_CONTROL_AGENT_PING_RESPONSE::seq() { return (uint16_t &)(*m_seq); }

uint16_t &cACTION_CONTROL_AGENT_PING_RESPONSE::size() { return (uint16_t &)(*m_size); }
...
cACTION_CONTROL_ARP_QUERY_REQUEST::cACTION_CONTROL_ARP_QUERY_REQUEST(uint8_t *buff, size_t buff_len,
                                                                     bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_ARP_QUERY_REQUEST::~cACTION_CONTROL_ARP_QUERY_REQUEST() {}
sArpQuery &cACTION_CONTROL_ARP_QUERY_REQUEST::params() { return (sArpQuery &)(*m_params); }

void cACTION_CONTROL_ARP_QUERY_REQUEST::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_ARP_QUERY_RESPONSE::cACTION_CONTROL_ARP_QUERY_RESPONSE(uint8_t *buff,
                                                                       size_t buff_len, bool parse,
                                                                       bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
...
void cACTION_CONTROL_ARP_QUERY_RESPONSE::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_VERSION_MISMATCH_NOTIFICATION::class_swap() { m_versions->struct_swap(); }
...
cACTION_CONTROL_PLATFORM_OPERATIONAL_NOTIFICATION::
    cACTION_CONTROL_PLATFORM_OPERATIONAL_NOTIFICATION(uint8_t *buff, size_t buff_len, bool parse,
                                                      bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_PLATFORM_OPERATIONAL_NOTIFICATION::
    cACTION_CONTROL_PLATFORM_OPERATIONAL_NOTIFICATION(std::shared_ptr<BaseClass> base, bool parse,
                                                      bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_BACKHAUL_DL_RSSI_REPORT_NOTIFICATION::
    cACTION_CONTROL_BACKHAUL_DL_RSSI_REPORT_NOTIFICATION(uint8_t *buff, size_t buff_len, bool parse,
                                                         bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_BACKHAUL_DL_RSSI_REPORT_NOTIFICATION::
    cACTION_CONTROL_BACKHAUL_DL_RSSI_REPORT_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                         bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_BACKHAUL_DL_RSSI_REPORT_NOTIFICATION::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_BACKHAUL_RESET::cACTION_CONTROL_BACKHAUL_RESET(uint8_t *buff, size_t buff_len,
                                                               bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
}
cACTION_CONTROL_BACKHAUL_RESET::cACTION_CONTROL_BACKHAUL_RESET(std::shared_ptr<BaseClass> base,
                                                               bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_BACKHAUL_ROAM_REQUEST::cACTION_CONTROL_BACKHAUL_ROAM_REQUEST(uint8_t *buff,
                                                                             size_t buff_len,
                                                                             bool parse,
                                                                             bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
void cACTION_CONTROL_BACKHAUL_ROAM_REQUEST::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_CHANGE_MODULE_LOGGING_LEVEL::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PREPARE_REQUEST::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PREPARE_REQUEST(uint8_t *buff, size_t buff_len,
                                                            bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PREPARE_REQUEST::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PREPARE_REQUEST(std::shared_ptr<BaseClass> base,
                                                            bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PREPARE_RESPONSE::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PREPARE_RESPONSE(uint8_t *buff, size_t buff_len,
                                                             bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PREPARE_RESPONSE::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PREPARE_RESPONSE(std::shared_ptr<BaseClass> base,
                                                             bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PRE_COMMIT_REQUEST::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PRE_COMMIT_REQUEST(uint8_t *buff, size_t buff_len,
                                                               bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PRE_COMMIT_REQUEST::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PRE_COMMIT_REQUEST(std::shared_ptr<BaseClass> base,
                                                               bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PRE_COMMIT_RESPONSE::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PRE_COMMIT_RESPONSE(uint8_t *buff, size_t buff_len,
                                                                bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PRE_COMMIT_RESPONSE::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_PRE_COMMIT_RESPONSE(std::shared_ptr<BaseClass> base,
                                                                bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_COMMIT_REQUEST::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_COMMIT_REQUEST(uint8_t *buff, size_t buff_len,
                                                           bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_COMMIT_REQUEST::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_COMMIT_REQUEST(std::shared_ptr<BaseClass> base,
                                                           bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_ABORT_REQUEST::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_ABORT_REQUEST(uint8_t *buff, size_t buff_len,
                                                          bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_ABORT_REQUEST::
    cACTION_CONTROL_WIFI_CREDENTIALS_UPDATE_ABORT_REQUEST(std::shared_ptr<BaseClass> base,
                                                          bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_TX_ON_REQUEST::cACTION_CONTROL_HOSTAP_TX_ON_REQUEST(uint8_t *buff,
                                                                           size_t buff_len,
                                                                           bool parse,
                                                                           bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
cACTION_CONTROL_HOSTAP_TX_OFF_REQUEST::cACTION_CONTROL_HOSTAP_TX_OFF_REQUEST(uint8_t *buff,
                                                                             size_t buff_len,
                                                                             bool parse,
                                                                             bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
cACTION_CONTROL_HOSTAP_TX_ON_RESPONSE::cACTION_CONTROL_HOSTAP_TX_ON_RESPONSE(uint8_t *buff,
                                                                             size_t buff_len,
                                                                             bool parse,
                                                                             bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
void cACTION_CONTROL_HOSTAP_CSA_ERROR_NOTIFICATION::class_swap() { m_cs_params->struct_swap(); }
...
cACTION_CONTROL_HOSTAP_CSA_NOTIFICATION::cACTION_CONTROL_HOSTAP_CSA_NOTIFICATION(uint8_t *buff,
                                                                                 size_t buff_len,
                                                                                 bool parse,
                                                                                 bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
void cACTION_CONTROL_HOSTAP_CSA_NOTIFICATION::class_swap() { m_cs_params->struct_swap(); }
...
void cACTION_CONTROL_HOSTAP_ACS_ERROR_NOTIFICATION::class_swap() { m_cs_params->struct_swap(); }
...
cACTION_CONTROL_HOSTAP_ACS_NOTIFICATION::cACTION_CONTROL_HOSTAP_ACS_NOTIFICATION(uint8_t *buff,
                                                                                 size_t buff_len,
                                                                                 bool parse,
                                                                                 bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
std::tuple<bool, sWifiChannel &>
cACTION_CONTROL_HOSTAP_ACS_NOTIFICATION::supported_channels(size_t idx)
{
...
size_t cACTION_CONTROL_HOSTAP_ACS_NOTIFICATION::get_initial_size()
{
    ...
    class_size += sizeof(sApChannelSwitch); // cs_params
    class_size +=
        beerocks::message::SUPPORTED_CHANNELS_LENGTH * sizeof(sWifiChannel); // supported_channels
    return class_size;
}
...
bool cACTION_CONTROL_HOSTAP_ACS_NOTIFICATION::init()
{
    ...
    if (!m_parse__) {
        for (size_t i = 0; i < beerocks::message::SUPPORTED_CHANNELS_LENGTH; i++) {
            m_supported_channels->struct_init();
        }
    }
    if (m_buff_ptr__ - m_buff__ > ssize_t(m_buff_len__)) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
...
cACTION_CONTROL_HOSTAP_DFS_CAC_COMPLETED_NOTIFICATION::
    cACTION_CONTROL_HOSTAP_DFS_CAC_COMPLETED_NOTIFICATION(uint8_t *buff, size_t buff_len,
                                                          bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_DFS_CAC_COMPLETED_NOTIFICATION::
    cACTION_CONTROL_HOSTAP_DFS_CAC_COMPLETED_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                          bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_DFS_CHANNEL_AVAILABLE_NOTIFICATION::
    cACTION_CONTROL_HOSTAP_DFS_CHANNEL_AVAILABLE_NOTIFICATION(uint8_t *buff, size_t buff_len,
                                                              bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_DFS_CHANNEL_AVAILABLE_NOTIFICATION::
    cACTION_CONTROL_HOSTAP_DFS_CHANNEL_AVAILABLE_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                              bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_SET_RESTRICTED_FAILSAFE_CHANNEL_REQUEST::
    cACTION_CONTROL_HOSTAP_SET_RESTRICTED_FAILSAFE_CHANNEL_REQUEST(uint8_t *buff, size_t buff_len,
                                                                   bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_SET_RESTRICTED_FAILSAFE_CHANNEL_REQUEST::
    cACTION_CONTROL_HOSTAP_SET_RESTRICTED_FAILSAFE_CHANNEL_REQUEST(std::shared_ptr<BaseClass> base,
                                                                   bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_SET_RESTRICTED_FAILSAFE_CHANNEL_RESPONSE::
    cACTION_CONTROL_HOSTAP_SET_RESTRICTED_FAILSAFE_CHANNEL_RESPONSE(uint8_t *buff, size_t buff_len,
                                                                    bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_SET_RESTRICTED_FAILSAFE_CHANNEL_RESPONSE::
    cACTION_CONTROL_HOSTAP_SET_RESTRICTED_FAILSAFE_CHANNEL_RESPONSE(std::shared_ptr<BaseClass> base,
                                                                    bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_HOSTAP_CHANNEL_SWITCH_ACS_START::class_swap() { m_cs_params->struct_swap(); }
...
cACTION_CONTROL_HOSTAP_UPDATE_STOP_ON_FAILURE_ATTEMPTS_REQUEST::
    cACTION_CONTROL_HOSTAP_UPDATE_STOP_ON_FAILURE_ATTEMPTS_REQUEST(uint8_t *buff, size_t buff_len,
                                                                   bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_UPDATE_STOP_ON_FAILURE_ATTEMPTS_REQUEST::
    cACTION_CONTROL_HOSTAP_UPDATE_STOP_ON_FAILURE_ATTEMPTS_REQUEST(std::shared_ptr<BaseClass> base,
                                                                   bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_HOSTAP_CHANNEL_SWITCH_REQUEST::class_swap() { m_cs_params->struct_swap(); }
...
uint8_t &cACTION_CONTROL_HOSTAP_STATS_MEASUREMENT_REQUEST::sync() { return (uint8_t &)(*m_sync); }
...
cACTION_CONTROL_HOSTAP_STATS_MEASUREMENT_RESPONSE::
    cACTION_CONTROL_HOSTAP_STATS_MEASUREMENT_RESPONSE(uint8_t *buff, size_t buff_len, bool parse,
                                                      bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_STATS_MEASUREMENT_RESPONSE::
    cACTION_CONTROL_HOSTAP_STATS_MEASUREMENT_RESPONSE(std::shared_ptr<BaseClass> base, bool parse,
                                                      bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_STATS_MEASUREMENT_RESPONSE::sta_stats(size_t idx)
{
...
cACTION_CONTROL_HOSTAP_LOAD_MEASUREMENT_NOTIFICATION::
    cACTION_CONTROL_HOSTAP_LOAD_MEASUREMENT_NOTIFICATION(uint8_t *buff, size_t buff_len, bool parse,
                                                         bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_LOAD_MEASUREMENT_NOTIFICATION::
    cACTION_CONTROL_HOSTAP_LOAD_MEASUREMENT_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                         bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_HOSTAP_LOAD_MEASUREMENT_NOTIFICATION::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_HOSTAP_SET_NEIGHBOR_11K_REQUEST::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_HOSTAP_REMOVE_NEIGHBOR_11K_REQUEST::
    cACTION_CONTROL_HOSTAP_REMOVE_NEIGHBOR_11K_REQUEST(uint8_t *buff, size_t buff_len, bool parse,
                                                       bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_REMOVE_NEIGHBOR_11K_REQUEST::
    cACTION_CONTROL_HOSTAP_REMOVE_NEIGHBOR_11K_REQUEST(std::shared_ptr<BaseClass> base, bool parse,
                                                       bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_HOSTAP_REMOVE_NEIGHBOR_11K_REQUEST::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_HOSTAP_ACTIVITY_NOTIFICATION::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_HOSTAP_VAPS_LIST_UPDATE_NOTIFICATION::
    cACTION_CONTROL_HOSTAP_VAPS_LIST_UPDATE_NOTIFICATION(uint8_t *buff, size_t buff_len, bool parse,
                                                         bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_HOSTAP_VAPS_LIST_UPDATE_NOTIFICATION::
    cACTION_CONTROL_HOSTAP_VAPS_LIST_UPDATE_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                         bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_HOSTAP_VAPS_LIST_UPDATE_NOTIFICATION::class_swap() { m_params->struct_swap(); }
...
int8_t &cACTION_CONTROL_HOSTAP_AP_DISABLED_NOTIFICATION::vap_id() { return (int8_t &)(*m_vap_id); }
...
cACTION_CONTROL_HOSTAP_AP_ENABLED_NOTIFICATION::~cACTION_CONTROL_HOSTAP_AP_ENABLED_NOTIFICATION() {}
int8_t &cACTION_CONTROL_HOSTAP_AP_ENABLED_NOTIFICATION::vap_id() { return (int8_t &)(*m_vap_id); }
...
void cACTION_CONTROL_HOSTAP_AP_ENABLED_NOTIFICATION::class_swap() { m_vap_info->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_START_MONITORING_REQUEST::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_STOP_MONITORING_REQUEST::class_swap() { m_mac->struct_swap(); }
...
cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_REQUEST::
    cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_REQUEST(uint8_t *buff, size_t buff_len, bool parse,
                                                       bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_REQUEST::
    cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_REQUEST(std::shared_ptr<BaseClass> base, bool parse,
                                                       bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_REQUEST::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_RESPONSE::
    cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_RESPONSE(uint8_t *buff, size_t buff_len, bool parse,
                                                        bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_RESPONSE::
    cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_RESPONSE(std::shared_ptr<BaseClass> base, bool parse,
                                                        bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_RESPONSE::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_START_NOTIFICATION::
    cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_START_NOTIFICATION(uint8_t *buff, size_t buff_len,
                                                                  bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_START_NOTIFICATION::
    cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_START_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                                  bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_CMD_RESPONSE::
    cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_CMD_RESPONSE(uint8_t *buff, size_t buff_len,
                                                            bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_CMD_RESPONSE::
    cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_CMD_RESPONSE(std::shared_ptr<BaseClass> base,
                                                            bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_CMD_RESPONSE::class_swap() { m_mac->struct_swap(); }
...
cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_NOTIFICATION::
    cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_NOTIFICATION(uint8_t *buff, size_t buff_len,
                                                            bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_NOTIFICATION::
    cACTION_CONTROL_CLIENT_RX_RSSI_MEASUREMENT_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                            bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_CLIENT_NO_ACTIVITY_NOTIFICATION::class_swap() { m_mac->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_NO_RESPONSE_NOTIFICATION::class_swap() { m_mac->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_ASSOCIATED_NOTIFICATION::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_DISCONNECTED_NOTIFICATION::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_CLIENT_DISALLOW_REQUEST::cACTION_CONTROL_CLIENT_DISALLOW_REQUEST(uint8_t *buff,
                                                                                 size_t buff_len,
                                                                                 bool parse,
                                                                                 bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
void cACTION_CONTROL_CLIENT_DISALLOW_REQUEST::class_swap() { m_mac->struct_swap(); }
...
cACTION_CONTROL_CLIENT_ALLOW_REQUEST::cACTION_CONTROL_CLIENT_ALLOW_REQUEST(uint8_t *buff,
                                                                           size_t buff_len,
                                                                           bool parse,
                                                                           bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
int8_t &cACTION_CONTROL_CLIENT_DISCONNECT_REQUEST::vap_id() { return (int8_t &)(*m_vap_id); }

uint32_t &cACTION_CONTROL_CLIENT_DISCONNECT_REQUEST::type() { return (uint32_t &)(*m_type); }

uint32_t &cACTION_CONTROL_CLIENT_DISCONNECT_REQUEST::reason() { return (uint32_t &)(*m_reason); }
...
void cACTION_CONTROL_CLIENT_DISCONNECT_RESPONSE::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_CLIENT_BSS_STEER_REQUEST::cACTION_CONTROL_CLIENT_BSS_STEER_REQUEST(uint8_t *buff,
                                                                                   size_t buff_len,
                                                                                   bool parse,
                                                                                   bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
...
void cACTION_CONTROL_CLIENT_BSS_STEER_REQUEST::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_BSS_STEER_RESPONSE::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_CLIENT_DHCP_COMPLETE_NOTIFICATION::
    cACTION_CONTROL_CLIENT_DHCP_COMPLETE_NOTIFICATION(uint8_t *buff, size_t buff_len, bool parse,
                                                      bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_CLIENT_DHCP_COMPLETE_NOTIFICATION::
    cACTION_CONTROL_CLIENT_DHCP_COMPLETE_NOTIFICATION(std::shared_ptr<BaseClass> base, bool parse,
                                                      bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_CLIENT_ARP_MONITOR_NOTIFICATION::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_BEACON_11K_REQUEST::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_BEACON_11K_RESPONSE::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_CHANNEL_LOAD_11K_REQUEST::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_CHANNEL_LOAD_11K_RESPONSE::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_STATISTICS_11K_REQUEST::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_CLIENT_STATISTICS_11K_RESPONSE::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_CLIENT_LINK_MEASUREMENT_11K_REQUEST::
    cACTION_CONTROL_CLIENT_LINK_MEASUREMENT_11K_REQUEST(uint8_t *buff, size_t buff_len, bool parse,
                                                        bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_CLIENT_LINK_MEASUREMENT_11K_REQUEST::
    cACTION_CONTROL_CLIENT_LINK_MEASUREMENT_11K_REQUEST(std::shared_ptr<BaseClass> base, bool parse,
                                                        bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_CLIENT_LINK_MEASUREMENT_11K_REQUEST::class_swap() { m_mac->struct_swap(); }
...
cACTION_CONTROL_CLIENT_LINK_MEASUREMENTS_11K_RESPONSE::
    cACTION_CONTROL_CLIENT_LINK_MEASUREMENTS_11K_RESPONSE(uint8_t *buff, size_t buff_len,
                                                          bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_CLIENT_LINK_MEASUREMENTS_11K_RESPONSE::
    cACTION_CONTROL_CLIENT_LINK_MEASUREMENTS_11K_RESPONSE(std::shared_ptr<BaseClass> base,
                                                          bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_STEERING_CLIENT_SET_GROUP_REQUEST::
    cACTION_CONTROL_STEERING_CLIENT_SET_GROUP_REQUEST(uint8_t *buff, size_t buff_len, bool parse,
                                                      bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_STEERING_CLIENT_SET_GROUP_REQUEST::
    cACTION_CONTROL_STEERING_CLIENT_SET_GROUP_REQUEST(std::shared_ptr<BaseClass> base, bool parse,
                                                      bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_STEERING_CLIENT_SET_GROUP_REQUEST::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_STEERING_CLIENT_SET_GROUP_RESPONSE::
    cACTION_CONTROL_STEERING_CLIENT_SET_GROUP_RESPONSE(uint8_t *buff, size_t buff_len, bool parse,
                                                       bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_STEERING_CLIENT_SET_GROUP_RESPONSE::
    cACTION_CONTROL_STEERING_CLIENT_SET_GROUP_RESPONSE(std::shared_ptr<BaseClass> base, bool parse,
                                                       bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_STEERING_CLIENT_SET_GROUP_RESPONSE::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_STEERING_CLIENT_SET_REQUEST::class_swap() { m_params->struct_swap(); }
...
void cACTION_CONTROL_STEERING_CLIENT_SET_RESPONSE::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_STEERING_EVENT_CLIENT_ACTIVITY_NOTIFICATION::
    cACTION_CONTROL_STEERING_EVENT_CLIENT_ACTIVITY_NOTIFICATION(uint8_t *buff, size_t buff_len,
                                                                bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_STEERING_EVENT_CLIENT_ACTIVITY_NOTIFICATION::
    cACTION_CONTROL_STEERING_EVENT_CLIENT_ACTIVITY_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                                bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_STEERING_EVENT_SNR_XING_NOTIFICATION::
    cACTION_CONTROL_STEERING_EVENT_SNR_XING_NOTIFICATION(uint8_t *buff, size_t buff_len, bool parse,
                                                         bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_STEERING_EVENT_SNR_XING_NOTIFICATION::
    cACTION_CONTROL_STEERING_EVENT_SNR_XING_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                         bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
void cACTION_CONTROL_STEERING_EVENT_SNR_XING_NOTIFICATION::class_swap() { m_params->struct_swap(); }
...
cACTION_CONTROL_STEERING_EVENT_PROBE_REQ_NOTIFICATION::
    cACTION_CONTROL_STEERING_EVENT_PROBE_REQ_NOTIFICATION(uint8_t *buff, size_t buff_len,
                                                          bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_STEERING_EVENT_PROBE_REQ_NOTIFICATION::
    cACTION_CONTROL_STEERING_EVENT_PROBE_REQ_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                          bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_STEERING_EVENT_AUTH_FAIL_NOTIFICATION::
    cACTION_CONTROL_STEERING_EVENT_AUTH_FAIL_NOTIFICATION(uint8_t *buff, size_t buff_len,
                                                          bool parse, bool swap_needed)
    : BaseClass(buff, buff_len, parse, swap_needed)
{
    m_init_succeeded = init();
...
cACTION_CONTROL_STEERING_EVENT_AUTH_FAIL_NOTIFICATION::
    cACTION_CONTROL_STEERING_EVENT_AUTH_FAIL_NOTIFICATION(std::shared_ptr<BaseClass> base,
                                                          bool parse, bool swap_needed)
    : BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse, swap_needed)
{
    m_init_succeeded = init();
