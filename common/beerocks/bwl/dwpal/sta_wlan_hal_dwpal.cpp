                                         ...
                                         bool parse_vsie)
{
    ...
    */
    ...
    FieldsToParse fieldsToParse[] = {
        {(void *)scan_results[0].bssid, &numOfValidArgs[0], DWPAL_STR_PARAM, "bssid=",
         sizeof(scan_results[0].bssid)},
        {(void *)scan_results[0].ssid, &numOfValidArgs[1], DWPAL_STR_PARAM, "ssid=",
         sizeof(scan_results[0].ssid)},
        ...
        {(void *)scan_results[0].vsie, &numOfValidArgs[4], DWPAL_STR_PARAM, "VEs=",
         sizeof(scan_results[0].vsie)},
        /* Must be at the end */
...
bool sta_wlan_hal_dwpal::read_status(ConnectionStatus &connection_status)
{
    ...
    FieldsToParse fieldsToParse[] = {
        ...
        {(void *)pairwise_cipher, &numOfValidArgs[5], DWPAL_STR_PARAM, "pairwise_cipher=",
         sizeof(pairwise_cipher)},
