                                                         ...
                                                         bool radio_5G)
{
    ...
    FieldsToParse fieldsToParse[]  = {
        ...
        {(void *)supported_rates, &numOfValidArgs[1], DWPAL_STR_PARAM, "supported_rates=",
...
bool ap_wlan_hal_dwpal::read_supported_channels()
{
    ...
    FieldsToParse fieldsToParse[] = {
        ...
        {(void *)dfs_state, &numOfValidArgs[1], DWPAL_STR_PARAM, "(DFS state = ",
         sizeof(dfs_state)},
        /* Must be at the end */
        {NULL, NULL, DWPAL_NUM_OF_PARSING_TYPES, NULL, 0}};
...
{
    return new bwl::dwpal::ap_wlan_hal_dwpal(iface_name, callback, hal_conf);
}
