...
ap_wlan_hal_wav::ap_wlan_hal_wav(std::string iface_name, bool acs_enabled, hal_event_cb_t callback)
...
bool ap_wlan_hal_wav::sta_bss_steer(const std::string &mac, const std::string &bssid, int chan,
...
bool ap_wlan_hal_wav::sta_unassoc_rssi_measurement(const std::string &mac, int chan, int bw,
