...
public:
    ...
    virtual bool sta_softblock_add(const std::string &vap_name, const std::string &client_mac,
                                   uint8_t reject_error_code, uint8_t probe_rssi_threshold_hi,
                                   uint8_t probe_rssi_threshold_lo,
                                   uint8_t authetication_rssi_threshold_hi,
                                   uint8_t authetication_rssi_threshold_lo) override
    {
        return false;
    }
