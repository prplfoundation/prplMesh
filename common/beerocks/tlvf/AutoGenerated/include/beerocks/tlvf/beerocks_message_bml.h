...
class cACTION_BML_REGISTER_TO_NW_MAP_UPDATES_RESPONSE : public BaseClass
{
    public:
        ...
        explicit cACTION_BML_REGISTER_TO_NW_MAP_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_BML_UNREGISTER_FROM_NW_MAP_UPDATES_RESPONSE : public BaseClass
{
    public:
        ...
        explicit cACTION_BML_UNREGISTER_FROM_NW_MAP_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_BML_REGISTER_TO_EVENTS_UPDATES_RESPONSE : public BaseClass
{
    public:
        ...
        explicit cACTION_BML_REGISTER_TO_EVENTS_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_BML_REGISTER_TO_STATS_UPDATES_RESPONSE : public BaseClass
{
    public:
        ...
        explicit cACTION_BML_REGISTER_TO_STATS_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_BML_UNREGISTER_FROM_STATS_UPDATES_RESPONSE : public BaseClass
{
    public:
        ...
        explicit cACTION_BML_UNREGISTER_FROM_STATS_UPDATES_RESPONSE(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_BML_WIFI_CREDENTIALS_SET_REQUEST : public BaseClass
{
    public:
        ...
        uint8_t& bss_type();
        uint8_t& operating_channel_size();
        uint8_t* operating_channels(size_t idx = 0);
        bool set_operating_channels(const void* buffer, size_t size);
        bool alloc_operating_channels(size_t count = 1);
        void class_swap() override;
        bool finalize() override;
        static size_t get_initial_size();
    ...
    private:
        ...
        uint8_t* m_operating_channel_size = nullptr;
        uint8_t* m_operating_channels = nullptr;
        size_t m_operating_channels_idx__ = 0;
};
...
class cACTION_BML_CHANNEL_SCAN_DUMP_RESULTS_RESPONSE : public BaseClass
{
    public:
        ...
        explicit cACTION_BML_CHANNEL_SCAN_DUMP_RESULTS_RESPONSE(std::shared_ptr<BaseClass> base, bool parse = false);
