...
enum eActionOp_CONTROL: uint8_t {
    ...
    ACTION_CONTROL_CLIENT_NEW_IP_ADDRESS_NOTIFICATION = 0x6b,
...
enum eActionOp_MONITOR: uint8_t {
    ...
    ACTION_MONITOR_CLIENT_NO_ACTIVITY_NOTIFICATION = 0x25,
    ACTION_MONITOR_CLIENT_NEW_IP_ADDRESS_NOTIFICATION = 0x26,
