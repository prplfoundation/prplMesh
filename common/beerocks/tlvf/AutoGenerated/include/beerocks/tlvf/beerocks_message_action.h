...
enum eActionOp_CONTROL: uint8_t {
    ...
    ACTION_CONTROL_CLIENT_STOP_MONITORING_REQUEST = 0x66,
...
enum eActionOp_MONITOR: uint8_t {
    ...
    ACTION_MONITOR_CLIENT_STOP_MONITORING_REQUEST = 0x16,
    ...
    ACTION_MONITOR_CLIENT_LINK_MEASUREMENT_11K_REQUEST = 0x23,
    ACTION_MONITOR_CLIENT_LINK_MEASUREMENTS_11K_RESPONSE = 0x24,
