...
enum eActionOp_CONTROL: uint8_t {
    ...
    ACTION_CONTROL_DCS_TRIGGER_SCAN_REQUEST = 0x8c,
    ACTION_CONTROL_DCS_TRIGGER_SCAN_RESPONSE = 0x8d,
    ACTION_CONTROL_DCS_SCAN_TRIGGERED_NOTIFICATION = 0x8e,
    ACTION_CONTROL_DCS_SCAN_RESULTS_NOTIFICATION = 0x8f,
    ACTION_CONTROL_DCS_SCAN_ABORT_NOTIFICATION = 0x90,
    ACTION_CONTROL_DCS_SCAN_FINISHED_NOTIFICATION = 0x91,
...
enum eActionOp_APMANAGER: uint8_t {
    ...
    ACTION_APMANAGER_WIFI_CREDENTIALS_UPDATE_REQUEST = 0x38,
    ACTION_APMANAGER_4ADDR_STA_JOINED = 0x46,
    ACTION_APMANAGER_HEARTBEAT_NOTIFICATION = 0x47,
    ACTION_APMANAGER_READ_ACS_REPORT_REQUEST = 0x48,
    ACTION_APMANAGER_READ_ACS_REPORT_RESPONSE = 0x49,
    ACTION_APMANAGER_ENUM_END = 0x4a,
};
...
enum eActionOp_MONITOR: uint8_t {
    ...
    ACTION_MONITOR_DCS_TRIGGER_SCAN_REQUEST = 0x3c,
    ACTION_MONITOR_DCS_TRIGGER_SCAN_RESPONSE = 0x3d,
    ACTION_MONITOR_DCS_SCAN_TRIGGERED_NOTIFICATION = 0x3e,
    ACTION_MONITOR_DCS_DUMP_SCAN_RESULTS_REQUEST = 0x3f,
    ACTION_MONITOR_DCS_DUMP_SCAN_RESULTS_RESPONSE = 0x40,
    ACTION_MONITOR_DCS_SCAN_RESULTS_NOTIFICATION = 0x41,
    ACTION_MONITOR_DCS_SCAN_ABORT_NOTIFICATION = 0x42,
    ACTION_MONITOR_DCS_SCAN_FINISHED_NOTIFICATION = 0x43,
    ACTION_MONITOR_ENUM_END = 0x46,
};
...
enum eActionOp_BML: uint8_t {
    ...
    ACTION_BML_DCS_SET_CONTINUOUS_PARAMS_REQUEST = 0xc8,
    ACTION_BML_DCS_SET_CONTINUOUS_PARAMS_RESPONSE = 0xc9,
    ACTION_BML_DCS_GET_CONTINUOUS_PARAMS_REQUEST = 0xca,
    ACTION_BML_DCS_GET_CONTINUOUS_PARAMS_RESPONSE = 0xcb,
    ACTION_BML_DCS_SET_CONTINUOUS_SCAN_ENABLE_REQUEST = 0xcc,
    ACTION_BML_DCS_SET_CONTINUOUS_SCAN_ENABLE_RESPONSE = 0xcd,
    ACTION_BML_DCS_GET_CONTINUOUS_SCAN_ENABLE_REQUEST = 0xce,
    ACTION_BML_DCS_GET_CONTINUOUS_SCAN_ENABLE_RESPONSE = 0xcf,
    ACTION_BML_DCS_GET_SCAN_RESULTS_REQUEST = 0xd0,
    ACTION_BML_DCS_GET_SCAN_RESULTS_RESPONSE = 0xd1,
    ACTION_BML_DCS_START_SCAN_REQUEST = 0xd2,
    ACTION_BML_DCS_START_SCAN_RESPONSE = 0xd3,
    ACTION_BML_DCS_DUMP_SCAN_RESULTS_REQUEST = 0xd4,
    ACTION_BML_DCS_DUMP_SCAN_RESULTS_RESPONSE = 0xd5,
    ACTION_BML_ENUM_END = 0xdc,
};
