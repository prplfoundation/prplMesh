...
enum eActionOp_CONTROL: uint8_t {
    ...
    ACTION_CONTROL_VERSION_MISMATCH_NOTIFICATION = 0xc,
    ACTION_CONTROL_PLATFORM_OPERATIONAL_NOTIFICATION = 0xd,
    ...
    ACTION_CONTROL_CLIENT_ASSOCIATED_NOTIFICATION = 0x6b,
    ACTION_CONTROL_CLIENT_DISCONNECTED_NOTIFICATION = 0x6c,
    ...
    ACTION_CONTROL_CLIENT_BSS_STEER_REQUEST = 0x71,
...
enum eActionOp_BACKHAUL: uint8_t {
    ...
    ACTION_BACKHAUL_ENABLE_APS_NOTIFICATION = 0xc,
...
enum eActionOp_APMANAGER: uint8_t {
    ...
    ACTION_APMANAGER_ENABLE_APS_REQUEST = 0x2,
    ACTION_APMANAGER_ENABLE_APS_RESPONSE = 0x3,
