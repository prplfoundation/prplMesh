...
enum eActionOp_CONTROL: uint8_t {
    ...
    ACTION_CONTROL_SLAVE_JOINED_4ADDR_MODE_NOTIFICATION = 0xa,
...
enum eActionOp_BACKHAUL: uint8_t {
    ...
    ACTION_BACKHAUL_CLIENT_ASSOCIATED_STA_LINK_METRIC_QUERY = 0x28,
    ACTION_BACKHAUL_CLIENT_ASSOCIATED_STA_LINK_METRIC_RESPONSE = 0x29,
...
enum eActionOp_MONITOR: uint8_t {
    ...
    ACTION_MONITOR_CLIENT_ASSOCIATED_STA_LINK_METRIC_QUERY = 0x28,
