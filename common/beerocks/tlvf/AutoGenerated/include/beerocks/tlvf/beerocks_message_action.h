...
enum eActionOp_CONTROL: uint8_t {
    ...
    ACTION_CONTROL_CHANNEL_SCAN_TRIGGERED_NOTIFICATION = 0x8e,
    ACTION_CONTROL_CHANNEL_SCAN_RESULTS_NOTIFICATION = 0x8f,
    ACTION_CONTROL_CHANNEL_SCAN_ABORT_NOTIFICATION = 0x90,
    ACTION_CONTROL_CHANNEL_SCAN_FINISHED_NOTIFICATION = 0x91,
    ACTION_CONTROL_ENUM_END = 0x92,
};
...
enum eActionOp_BACKHAUL: uint8_t {
    ...
    ACTION_BACKHAUL_ONBOARDING_FINISHED_NOTIFICATION = 0xd,
...
enum eActionOp_MONITOR: uint8_t {
    ...
    ACTION_MONITOR_CHANNEL_DUMP_SCAN_RESULTS_REQUEST = 0x3f,
    ACTION_MONITOR_CHANNEL_DUMP_SCAN_RESULTS_RESPONSE = 0x40,
