...
enum eActionOp_CONTROL: uint8_t {
    ...
    ACTION_CONTROL_SLAVE_JOINED_NOTIFICATION = 0x2,
    ACTION_CONTROL_SLAVE_JOINED_RESPONSE = 0x3,
    ACTION_CONTROL_SON_CONFIG_UPDATE = 0x4,
    ACTION_CONTROL_CONTROLLER_PING_REQUEST = 0x5,
    ACTION_CONTROL_CONTROLLER_PING_RESPONSE = 0x6,
    ACTION_CONTROL_AGENT_PING_REQUEST = 0x7,
    ACTION_CONTROL_AGENT_PING_RESPONSE = 0x8,
    ACTION_CONTROL_SLAVE_JOINED_4ADDR_MODE_NOTIFICATION = 0x9,
    ACTION_CONTROL_CHANGE_MODULE_LOGGING_LEVEL = 0xa,
    ACTION_CONTROL_ARP_QUERY_REQUEST = 0xb,
    ACTION_CONTROL_ARP_QUERY_RESPONSE = 0xc,
