...
class cACTION_CONTROL_DCS_TRIGGER_SCAN_REQUEST : public BaseClass
{
    public:
        cACTION_CONTROL_DCS_TRIGGER_SCAN_REQUEST(uint8_t* buff, size_t buff_len, bool parse = false, bool swap_needed = false);
        cACTION_CONTROL_DCS_TRIGGER_SCAN_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false, bool swap_needed = false);
        ~cACTION_CONTROL_DCS_TRIGGER_SCAN_REQUEST();

        static eActionOp_CONTROL get_action_op(){
            return (eActionOp_CONTROL)(ACTION_CONTROL_DCS_TRIGGER_SCAN_REQUEST);
        }
...
class cACTION_CONTROL_DCS_TRIGGER_SCAN_RESPONSE : public BaseClass
{
    public:
        cACTION_CONTROL_DCS_TRIGGER_SCAN_RESPONSE(uint8_t* buff, size_t buff_len, bool parse = false, bool swap_needed = false);
        cACTION_CONTROL_DCS_TRIGGER_SCAN_RESPONSE(std::shared_ptr<BaseClass> base, bool parse = false, bool swap_needed = false);
        ~cACTION_CONTROL_DCS_TRIGGER_SCAN_RESPONSE();

        static eActionOp_CONTROL get_action_op(){
            return (eActionOp_CONTROL)(ACTION_CONTROL_DCS_TRIGGER_SCAN_RESPONSE);
        }
        uint8_t& success();
        void class_swap();
        static size_t get_initial_size();
...
class cACTION_CONTROL_DCS_SCAN_TRIGGERED_NOTIFICATION : public BaseClass
{
    public:
        cACTION_CONTROL_DCS_SCAN_TRIGGERED_NOTIFICATION(uint8_t* buff, size_t buff_len, bool parse = false, bool swap_needed = false);
        cACTION_CONTROL_DCS_SCAN_TRIGGERED_NOTIFICATION(std::shared_ptr<BaseClass> base, bool parse = false, bool swap_needed = false);
        ~cACTION_CONTROL_DCS_SCAN_TRIGGERED_NOTIFICATION();

        static eActionOp_CONTROL get_action_op(){
            return (eActionOp_CONTROL)(ACTION_CONTROL_DCS_SCAN_TRIGGERED_NOTIFICATION);
        }
        void class_swap();
        static size_t get_initial_size();
...
class cACTION_CONTROL_DCS_SCAN_RESULTS_NOTIFICATION : public BaseClass
{
    public:
        cACTION_CONTROL_DCS_SCAN_RESULTS_NOTIFICATION(uint8_t* buff, size_t buff_len, bool parse = false, bool swap_needed = false);
        cACTION_CONTROL_DCS_SCAN_RESULTS_NOTIFICATION(std::shared_ptr<BaseClass> base, bool parse = false, bool swap_needed = false);
        ~cACTION_CONTROL_DCS_SCAN_RESULTS_NOTIFICATION();

        static eActionOp_CONTROL get_action_op(){
            return (eActionOp_CONTROL)(ACTION_CONTROL_DCS_SCAN_RESULTS_NOTIFICATION);
        }
...
class cACTION_CONTROL_DCS_SCAN_ABORT_NOTIFICATION : public BaseClass
{
    public:
        cACTION_CONTROL_DCS_SCAN_ABORT_NOTIFICATION(uint8_t* buff, size_t buff_len, bool parse = false, bool swap_needed = false);
        cACTION_CONTROL_DCS_SCAN_ABORT_NOTIFICATION(std::shared_ptr<BaseClass> base, bool parse = false, bool swap_needed = false);
        ~cACTION_CONTROL_DCS_SCAN_ABORT_NOTIFICATION();

        static eActionOp_CONTROL get_action_op(){
            return (eActionOp_CONTROL)(ACTION_CONTROL_DCS_SCAN_ABORT_NOTIFICATION);
        }
        uint8_t& reason();
        void class_swap();
        static size_t get_initial_size();
...
class cACTION_CONTROL_DCS_SCAN_FINISHED_NOTIFICATION : public BaseClass
{
    public:
        cACTION_CONTROL_DCS_SCAN_FINISHED_NOTIFICATION(uint8_t* buff, size_t buff_len, bool parse = false, bool swap_needed = false);
        cACTION_CONTROL_DCS_SCAN_FINISHED_NOTIFICATION(std::shared_ptr<BaseClass> base, bool parse = false, bool swap_needed = false);
        ~cACTION_CONTROL_DCS_SCAN_FINISHED_NOTIFICATION();

        static eActionOp_CONTROL get_action_op(){
            return (eActionOp_CONTROL)(ACTION_CONTROL_DCS_SCAN_FINISHED_NOTIFICATION);
        }
        void class_swap();
        static size_t get_initial_size();
