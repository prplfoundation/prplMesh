...
class cACTION_CLI_ENABLE_DIAGNOSTICS_MEASUREMENTS : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_ENABLE_DIAGNOSTICS_MEASUREMENTS(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_ENABLE_DEBUG : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_ENABLE_DEBUG(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_SET_SLAVES_STOP_ON_FAILURE_ATTEMPTS : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_SET_SLAVES_STOP_ON_FAILURE_ATTEMPTS(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_RESPONSE_STR : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_RESPONSE_STR(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_CROSS_RX_RSSI_MEASUREMENT : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_CROSS_RX_RSSI_MEASUREMENT(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_OPTIMAL_PATH_TASK : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_OPTIMAL_PATH_TASK(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_LOAD_BALANCER_TASK : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_LOAD_BALANCER_TASK(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_IRE_NETWORK_OPTIMIZATION_TASK : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_IRE_NETWORK_OPTIMIZATION_TASK(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_DUMP_NODE_INFO : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_DUMP_NODE_INFO(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_BACKHAUL_ROAM_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_BACKHAUL_ROAM_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_CLIENT_ALLOW_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_CLIENT_ALLOW_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_CLIENT_DISALLOW_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_CLIENT_DISALLOW_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_CLIENT_DISCONNECT_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_CLIENT_DISCONNECT_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_CLIENT_BSS_STEER_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_CLIENT_BSS_STEER_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_CLIENT_CHANNEL_LOAD_11K_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_CLIENT_CHANNEL_LOAD_11K_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_CLIENT_BEACON_11K_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_CLIENT_BEACON_11K_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_CLIENT_STATISTICS_11K_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_CLIENT_STATISTICS_11K_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_HOSTAP_CHANNEL_SWITCH_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_HOSTAP_CHANNEL_SWITCH_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_HOSTAP_SET_NEIGHBOR_11K_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_HOSTAP_SET_NEIGHBOR_11K_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_HOSTAP_REMOVE_NEIGHBOR_11K_REQUEST : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_HOSTAP_REMOVE_NEIGHBOR_11K_REQUEST(std::shared_ptr<BaseClass> base, bool parse = false);
...
class cACTION_CLI_HOSTAP_STATS_MEASUREMENT : public BaseClass
{
    public:
        ...
        explicit cACTION_CLI_HOSTAP_STATS_MEASUREMENT(std::shared_ptr<BaseClass> base, bool parse = false);
