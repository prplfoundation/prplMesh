...
bool config_file::read_master_config_file(std::string config_file_path, sConfigMaster &conf)
{
    ...
    tConfig master_conf_args = {
        ...
        std::make_tuple("ucc_listener_port=", &conf.ucc_listener_port, mandatory_master),
        ...
        std::make_tuple("load_client_band_steering=", &conf.load_client_band_steering,
                        mandatory_master),
        std::make_tuple("load_client_optimal_path_roaming=", &conf.load_client_optimal_path_roaming,
                        mandatory_master),
        ...
        std::make_tuple("ire_rssi_report_rate_sec=", &conf.ire_rssi_report_rate_sec,
                        mandatory_master),
        std::make_tuple("roaming_hysteresis_percent_bonus=", &conf.roaming_hysteresis_percent_bonus,
                        mandatory_master),
        std::make_tuple("roaming_unconnected_client_rssi_compensation_db=",
                        &conf.roaming_unconnected_client_rssi_compensation_db, mandatory_master),
        std::make_tuple("roaming_hop_percent_penalty=", &conf.roaming_hop_percent_penalty,
                        mandatory_master),
        ...
        std::make_tuple("roaming_24ghz_failed_attemps_threshold=",
                        &conf.roaming_24ghz_failed_attemps_threshold, mandatory_master),
        std::make_tuple("roaming_11v_failed_attemps_threshold=",
                        &conf.roaming_11v_failed_attemps_threshold, mandatory_master),
        std::make_tuple("roaming_rssi_cutoff_db=", &conf.roaming_rssi_cutoff_db, mandatory_master),
        std::make_tuple("roaming_sticky_client_rssi_threshold=",
                        &conf.roaming_sticky_client_rssi_threshold, mandatory_master),
        std::make_tuple("monitor_total_channel_load_notification_hi_th_percent=",
                        &conf.monitor_total_channel_load_notification_hi_th_percent,
                        mandatory_master),
        std::make_tuple("monitor_total_channel_load_notification_lo_th_percent=",
                        &conf.monitor_total_channel_load_notification_lo_th_percent,
                        mandatory_master),
        std::make_tuple("monitor_total_channel_load_notification_delta_th_percent=",
                        &conf.monitor_total_channel_load_notification_delta_th_percent,
                        mandatory_master),
        std::make_tuple("monitor_min_active_clients=", &conf.monitor_min_active_clients,
                        mandatory_master),
        std::make_tuple("monitor_active_client_th=", &conf.monitor_active_client_th,
                        mandatory_master),
        std::make_tuple("monitor_client_load_notification_delta_th_percent=",
                        &conf.monitor_client_load_notification_delta_th_percent, mandatory_master),
        std::make_tuple("monitor_ap_idle_threshold_B=", &conf.monitor_ap_idle_threshold_B,
                        mandatory_master),
        std::make_tuple("monitor_ap_active_threshold_B=", &conf.monitor_ap_active_threshold_B,
                        mandatory_master),
        std::make_tuple("monitor_ap_idle_stable_time_sec=", &conf.monitor_ap_idle_stable_time_sec,
                        mandatory_master),
        std::make_tuple("monitor_rx_rssi_notification_threshold_dbm=",
                        &conf.monitor_rx_rssi_notification_threshold_dbm, mandatory_master),
        ...
        std::make_tuple("fail_safe_5G_vht_frequency=", &conf.fail_safe_5G_vht_frequency,
                        mandatory_master),
        std::make_tuple("channel_selection_long_delay=", &conf.channel_selection_long_delay,
                        mandatory_master),
                                   ...
                                   std::string config_type)
{
    ...
    for (auto &conf : conf_args) {
        if (std::get<1>(conf)->empty() && (std::get<2>(conf) != 0)) {
            std::cout << config_file_path << ": mandatory config arg not set: " << std::get<0>(conf)
