...
enum eDcsScanErrCode : uint8_t {
    DCS_SCAN_NO_ERROR = 0,
    DCS_SCAN_INTERNAL_FAILURE,
    DCS_SCAN_CHANNEL_POOL_TOO_BIG,
    DCS_SCAN_SCAN_TRIGGERED_EVENT_TIMEOUT,
    DCS_SCAN_RESULTS_READY_EVENT_TIMEOUT,
    DCS_SCAN_RESULTS_DUMP_EVENT_TIMEOUT,
    DCS_SCAN_ABORTED_BY_DRIVER,
    DCS_SCAN_INVALID_SCAN_PARAMS
};

enum eDcsOpErrCode : uint8_t {
    DCS_OP_NO_ERROR = 0,
    DCS_OP_ERROR,
    DCS_OP_SCAN_IN_PROGRESS,
    DCS_OP_SCAN_RESULTS_EMPTY,
    DCS_OP_INVALID_PARAMS_ENABLE,
    DCS_OP_INVALID_PARAMS_DWELLTIME,
    DCS_OP_INVALID_PARAMS_SCANTIME,
    DCS_OP_INVALID_PARAMS_CHANNELPOOL
};
} // namespace beerocks
