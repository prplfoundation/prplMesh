...
enum eGlobals {
    ...
    BEACON_TRANSMIT_TIME_MS          = 100,
    BSS_STEER_DISASSOC_TIMER_MS      = 2000,
    BSS_STEER_IMMINENT_VALID_INT_BTT = (BSS_STEER_DISASSOC_TIMER_MS / BEACON_TRANSMIT_TIME_MS),
    BSS_STEER_VALID_INT_BTT          = 2, // 200ms
