...
inline void swap_64(int64_t &v) { v = htonll(v); }

inline void swap_64(uint64_t &v) { v = htonll(v); }

inline void swap_32(int32_t &v) { v = htonl(v); }

inline void swap_32(uint32_t &v) { v = htonl(v); }

inline void swap_16(int16_t &v) { v = htons(v); }
