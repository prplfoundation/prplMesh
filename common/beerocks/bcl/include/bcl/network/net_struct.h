...
/**
 * MMZ for coherence with other structs in this same file, operators == and !=
 * should be defined inside sMacAddr struct (which is autogenerated code).
 * Alternatively, move other structs so they are also autogenerated as sMacAddr
 */
