...
private:
    ...
    static constexpr sPhyRateTableEntry
        phy_rate_table[PHY_RATE_TABLE_ANT_MODE_MAX][PHY_RATE_TABLE_MCS_MAX] = {
            // 1X1_SS1_table
            {
                ...
                {18,
                 16,
                 {{130, 144, -865}, {270, 300, -841}, {585, 650, -805}, {1170, 1300, -775}}},
                {17,
                 15,
                 {{195, 217, -808}, {405, 450, -787}, {878, 975, -756}, {1175, 1950, -726}}},
                {17,
                 15,
                 {{260, 289, -811}, {540, 600, -790}, {1170, 1300, -753}, {2340, 2600, -723}}},
                {17,
                 15,
                 {{390, 433, -755}, {810, 900, -727}, {1755, 1950, -698}, {3510, 3900, -668}}},
                {17,
                 15,
                 {{520, 578, -717}, {1080, 1200, -686}, {2340, 2600, -656}, {4680, 5200, -626}}},
                {17,
                 14,
                 {{585, 650, -698}, {1215, 1350, -672}, {2633, 2925, -641}, {5265, 5850, -611}}},
                {16,
                 13,
                 {{650, 722, -673}, {1350, 1500, -647}, {2925, 3250, -632}, {5850, 6500, -602}}},
                {0,
                 10,
                 {{780, 867, -644}, {1620, 1800, -619}, {3510, 3900, -587}, {7020, 7800, -557}}},
            ...
            // 2X2_SS1_table
            {
                ...
                {18,
                 16,
                 {{130, 144, -900}, {270, 300, -879}, {585, 650, -840}, {1170, 1300, -810}}},
                {17,
                 15,
                 {{195, 217, -869}, {405, 450, -843}, {878, 975, -805}, {1175, 1950, -775}}},
                {17,
                 15,
                 {{260, 289, -858}, {540, 600, -831}, {1170, 1300, -792}, {2340, 2600, -762}}},
                {17,
                 15,
                 {{390, 433, -810}, {810, 900, -785}, {1755, 1950, -748}, {3510, 3900, -718}}},
                {17,
                 15,
                 {{520, 578, -773}, {1080, 1200, -742}, {2340, 2600, -704}, {4680, 5200, -674}}},
                {17,
                 14,
                 {{585, 650, -756}, {1215, 1350, -729}, {2633, 2925, -692}, {5265, 5850, -662}}},
                {16,
                 13,
                 {{650, 722, -735}, {1350, 1500, -709}, {2925, 3250, -684}, {5850, 6500, -654}}},
                {0,
                 10,
                 {{780, 867, -699}, {1620, 1800, -674}, {3510, 3900, -637}, {7020, 7800, -607}}},
            ...
            // 2X2_SS2_table
            {
                ...
                {18,
                 16,
                 {{130, 144, -890}, {270, 300, -861}, {585, 650, -834}, {1170, 1300, -804}}},
                {18,
                 16,
                 {{260, 288, -855}, {540, 600, -828}, {1170, 1300, -795}, {2340, 2600, -765}}},
                {17,
                 15,
                 {{390, 434, -815}, {810, 900, -784}, {1755, 1950, -756}, {3510, 3900, -726}}},
                {17,
                 15,
                 {{520, 578, -774}, {1080, 1200, -755}, {2340, 2600, -718}, {4680, 5200, -688}}},
                {17,
                 15,
                 {{780, 866, -720}, {1620, 1800, -699}, {3510, 3900, -669}, {7020, 7800, -639}}},
                {17,
                 15,
                 {{1040, 1156, -657}, {2160, 2400, -640}, {4680, 5200, -604}, {9360, 10400, -574}}},
                {17,
                 14,
                 {{1170, 1300, -648},
                  {2430, 2700, -628},
    ...
    static constexpr sPhyRateBitRateEntry bit_rate_max_table_mbps[BIT_RATE_MAX_TABLE_SIZE] = {
        {65, 3},     {130, 86},   {135, 71},   {195, 89},   {234, 107},  {260, 92},   {270, 125},
        {293, 129},  {390, 133},  {405, 139},  {520, 140},  {540, 141},  {585, 146},  {650, 147},
        {780, 148},  {810, 151},  {878, 151},  {1040, 161}, {1080, 172}, {1170, 182}, {1215, 156},
