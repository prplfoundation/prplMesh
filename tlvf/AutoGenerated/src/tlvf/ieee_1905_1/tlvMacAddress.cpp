...
const eTlvType &tlvMacAddress::type() { return (const eTlvType &)(*m_type); }

const uint16_t &tlvMacAddress::length() { return (const uint16_t &)(*m_length); }
...
bool tlvMacAddress::init()
{
    ...
    if (!m_parse__)
        *m_type = eTlvType::TLV_MAC_ADDRESS;
    else {
