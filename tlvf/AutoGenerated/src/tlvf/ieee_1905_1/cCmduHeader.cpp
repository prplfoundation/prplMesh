...
const uint8_t &cCmduHeader::message_version() { return (const uint8_t &)(*m_message_version); }

const uint8_t &cCmduHeader::reserved() { return (const uint8_t &)(*m_reserved); }

eMessageType &cCmduHeader::message_type() { return (eMessageType &)(*m_message_type); }

uint16_t &cCmduHeader::message_id() { return (uint16_t &)(*m_message_id); }

uint8_t &cCmduHeader::fragment_id() { return (uint8_t &)(*m_fragment_id); }

cCmduHeader::sFlags &cCmduHeader::flags() { return (sFlags &)(*m_flags); }
