    ...
    ieee1905_1::CmduMessageRx &cmdu_rx, ieee1905_1::CmduMessageTx &cmdu_tx)
{
    ...
    if (!is_gw_slave) {
        ...
        // if not local GGW but local master - then the parent bssid is remote AP (aka "far AP")
        // and is not yet in map
        // TODO adam: check if connection map needs adjustments to display "far AP" correctly
